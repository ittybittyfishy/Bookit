...
import com.example.booknook.BookRecommendationBookDetailsAdapter
...
class SearchBookRecommendationBookDetailsFragment : Fragment(), BookRecommendationBookDetailsAdapter.RecyclerViewEvent {
    ...
    private lateinit var bookRecommendationAdapter: BookRecommendationBookDetailsAdapter // Adapter to manage data for RecyclerView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d("SearchBookRecommendationsFragment", "Fetching recommendations for isbn: $isbn")
        ...
        bookRecommendationAdapter =
            isbn?.let { BookRecommendationBookDetailsAdapter(bookList, it, this) }!! // Initialize the adapter with the book list
