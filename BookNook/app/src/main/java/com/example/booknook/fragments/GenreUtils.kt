...
object GenreUtils {
    private val genreSynonyms = mapOf(
        ...
        "lgbtq+" to listOf("homosexuality", "gays", "gender identity"),
        "manga" to listOf("graphic novels", "comics"),
        "Comic Books" to listOf("graphic novels", "comic books", "manga", "cartoons"),
        ...
        "Juvenile Fiction" to listOf("juvenile fiction", "children's books", "young adult fiction"),
